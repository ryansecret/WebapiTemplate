...
namespace Ryan.Utility.ModelBinders
{
    ...
    public class MvcActionValueBinder : DefaultActionValueBinder
    {
        ...
        /// <summary>
        /// Default implementation of the <see cref="T:System.Web.Http.Controllers.IActionValueBinder" /> interface. This interface is the primary entry point for binding action parameters.
        /// </summary>
